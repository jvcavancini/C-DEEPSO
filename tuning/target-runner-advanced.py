...
def parse_output(out):
    #write the path of the RUN.m script in file_path
    file_path=''
    f = open(file_path)
    matlab_result=f.read()
    f.close()
...
if __name__=='__main__':
    ...
    #write the path of the RUN.m script in executable
    executable = ''
    fixed_params = ' -nosplash -nodesktop -nodisplay -r '
